...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-KCF2RKO;Database=CinemaDB;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Blacklist>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Blacklis__3214EC078354FDEA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Bookings__3214EC07A87A697B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChatMess__3214EC0790614698");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__contact___3213E83F802388A9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Movies__3214EC071FDA1B8B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__MovieCat__3214EC072637B45D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Payments__3214EC072D513C28");
            ...
            entity.HasOne(d => d.PrivateBooking).WithMany(p => p.Payments)
                ...
                .HasConstraintName("FK__Payments__Privat__02084FDA");
        });

        modelBuilder.Entity<PrivateBooking>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__PrivateB__3214EC07E869A2B0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PrivateR__3214EC070C65AC4D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Reviews__3214EC0744E407E8");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Rooms__3214EC0726706E59");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__RoomAvai__3214EC07C647969A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__RoomBook__3214EC07E47A0D88");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC070BA87F1F");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D105344ADB0DEE").IsUnique();
